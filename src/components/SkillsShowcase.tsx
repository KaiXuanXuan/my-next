    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-2xl p-8 shadow-xl border border-blue-200/60 flex flex-col md:col-span-3 relative overflow-hidden"
        >
          {/* 装饰性背景元素 */}
